...
<?php
	...
	if($jumlahBaris > 0 ){
        ...
        <div class="container">
        <a class="navbar-brand font-weight-bold" href="index.php?userName=khoirony&passWord=akuoke">Liputan 69</a>
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item active ml-2">
                <a class="nav-link" href="index.php?userName=khoirony&passWord=akuoke">Home <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item active ml-2">
                <a class="nav-link" href="index.php?userName=khoirony&passWord=akuoke#Politics">Politic</a>
            </li>
            <li class="nav-item active ml-2">
                <a class="nav-link" href="index.php?userName=khoirony&passWord=akuoke#Sport">Sport</a>
            </li>
                <li class="nav-item active ml-2">
                <a class="nav-link" href="index.php?userName=khoirony&passWord=akuoke#Tech">Tech</a>
            </li>
            <li class="nav-item active ml-2">
                <a class="nav-link" href="index.php?userName=khoirony&passWord=akuoke#Health">Health</a>
            </li>
            <li class="nav-item dropdown ml-4">
                ...
                <div class="dropdown-menu bg-dark mt-2 border-0 rounded-0" aria-labelledby="navbarDropdownMenuLink">
                    <a class="dropdown-item text-white" href="admin.php?userName=khoirony&passWord=akuoke">Update Berita</a>
                    <a class="dropdown-item text-white" href="tambah_berita.php?userName=khoirony&passWord=akuoke">Tambah Berita</a>
