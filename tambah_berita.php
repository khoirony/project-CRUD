...
<html lang="en">
  ...
  <body>
	...
	if(isset($_POST['Submit'])) {
		...
		echo '
		<h6>Berita baru berhasil ditambahkan. <a href="index.php?userName='.$arrayHasil[userName].'&passWord='.$arrayHasil[passWord].'"><span class="badge badge-secondary">Lihat Berita</span></a></h6> ';
	}
	?>
	...
	<?php echo'<form action="tambah_berita.php?userName='.$arrayHasil[userName].'&passWord='.$arrayHasil[passWord].'" method="post" name="form1">'; ?>
